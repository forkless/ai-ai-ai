...
$activatePath
python main.py --listen $comfyHost --port $comfyPort --output-directory "${Root}\AI_WORKSPACE\output" --temp-directory "${Root}\AI_CACHE\comfyui_temp" --reserve-vram 1.2$gpuFlag *>> "`$logFile"
"@
...
Set-Location "$ComfyPath"
$activatePath
python main.py --listen $listenAddr --port $comfyPort --output-directory "${Root}\AI_WORKSPACE\output" --temp-directory "${Root}\AI_CACHE\comfyui_temp" --reserve-vram 1.2$gpuFlag *>> "`$logFile"
"@
